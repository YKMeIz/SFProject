...
# fix Workspace background pref can be tricked to run arbitrary cmds
# http://repo.or.cz/w/wmaker-crm.git/commit/e11199d9cf45efcd52505da90c5430646de4ea26
Patch0:         WindowMaker-fix-wmsetbg-injection.patch
...
Patch1:         WindowMaker-fix-maxdock.patch
# fix maximizing window in multi screen env
# http://repo.or.cz/w/wmaker-crm.git/commit/efb7c6b3df445a5895df5c16e2279d20895082e2
Patch2:         WindowMaker-0.95.6-fix-maxwindow.patch
# create custom GNUSTEP dir if needed
# http://repo.or.cz/w/wmaker-crm.git/commit/416f5986856040881f4fef59c1170833f049e37f
Patch3:         WindowMaker-util-create-dir.patch
...
chrpath --delete %{buildroot}%{_libdir}/libWINGs.so.3.0.0
