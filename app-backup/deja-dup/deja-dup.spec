...
Source0:        http://launchpad.net/%{name}/30/%{version}/+download/%{name}-%{version}.tar.xz
BuildRequires:  cmake
...
BuildRequires:  nautilus-devel libsecret-devel
...
%build
%cmake -DENABLE_NAUTILUS=ON -DCMAKE_INSTALL_SYSCONFDIR=%{_sysconfdir}
make %{?_smp_mflags}
