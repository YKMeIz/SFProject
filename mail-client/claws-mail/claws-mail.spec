...
# rhbz#1079729 - but system libical breaks -> rhbz#1225903
#Patch10:        claws-mail-no-internal-libical.patch
#BuildRequires:  libical-devel
# version unknown and in ical headers replaced with Claws Mail version
Provides: bundled(libical)
