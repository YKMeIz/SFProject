# Use system nspr/nss?
%if 0%{?rhel} == 6 || 0%{?rhel} == 7 || 0%{?fedora} <= 22
%define system_nss        0
%else
%define system_nss        1
%endif
...
# Use GTK2 for flashplayer compatibility on RHEL and fedora
...
# Needed begining with firefox 29 and RHEL 6.
# Needed begining with firefox 45 and RHEL 7.
%if 0%{?rhel} >= 6
...
# RHEL 6 builds require devtoolset-2 and python27 in scl form.
%if 0%{?rhel} == 6
...
%changelog
* Mon Mar 21 2016 Gary Gatling <gsgatlin@ncsu.edu> - 45.0.1-2
- Apply patch to specfile for for RHEL 6/7 builds.
