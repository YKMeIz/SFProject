...
Version:	18.168.6.1
Release:	%{firmware_release}%{?dist}
Obsoletes:      iwl105-firmware < 18.168.6.1
...
Version:	18.168.6.1
Release:	%{firmware_release}%{?dist}
Obsoletes:      iwl135-firmware < 18.168.6.1
...
Version:	18.168.6.1
Release:	%{firmware_release}%{?dist}
Obsoletes:      iwl2000-firmware < 18.168.6.1
...
Version:	18.168.6.1
Release:	%{firmware_release}%{?dist}
Obsoletes:      iwl2030-firmware < 18.168.6.1
...
Version:	25.30.13.0
Release:	%{firmware_release}%{?dist}
Obsoletes:      iwl7260-firmware < 25.30.13.0
...
Version:	25.30.13.0
Release:	%{firmware_release}%{?dist}
Obsoletes:      iwl3160-firmware < 25.30.13.0
