...
%endif
Source50:        xscreensaver-5.32.ja.po.gz
##
## Patches
##
# bug 129335
...
%global PATCH22_desc \
# Patch for some GNOME issues with KeyPress
Patch22:         xscreensaver-5.32-jwz-GNOME-KeyPress.patch
#
%global PATCH32_desc \
...
# Disable SSE2 temporarily
# Fixed with gcc 5.0.0-0.10 (gcc bug 64981)
#Patch202:        xscreensaver-5.32-0002-fireworkx-disable-SSE2.patch
# visual.c: pick_best_gl_visual fix one byte ahead access
Patch203:        xscreensaver-5.32-0003-visual.c-pick_best_gl_visual-fix-one-byte-ahead-acce.patch
...
%patch22 -p1
  %__git commit -m "%PATCH22_desc" -a '--author=Jamie Zawinski <jwz@jwz.org>'
#%%patch32 -p1
  #%%__git commit -m "%%PATCH32_desc" -a

gzip -dc %{SOURCE50} > po/ja.po
%__git commit -m "Update Japanese po file" -a
