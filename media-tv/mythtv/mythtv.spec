...
%define vers_string v0.27.4-e4f65c8
...
%changelog
* Mon Oct 27 2014 Nux <rpm@li.nux.ro> - 0.27.4-1
- update to 0.27.4

* Fri Aug 15 2014 Bob Lightfoot <boblfoot@fedoraproject.org> - 0.27.3-1.1
- Modified to build >= el7 systemd all other el5,el6 SysV
- line 104 %if 0%{rhel} becomes %if 0%{rhel} < 7
- line 179 %if 0%{?fedora} >= 19 becomes %if 0%{?fedora} >= 19 || 0%{?rhel} >= 7
- line 362 %if 0%{?fedora} >= 19 becomes %if 0%{?fedora} >= 19 || 0%{?rhel} >= 7
- line 368 Requires: udisks becomes %if 0%{?rhel} >= 7 Requires: udisks2 %else Requires:  udisks %endif
- line 438 %if 0%{?fedora} >= 19 becomes %if 0%{?fedora} >= 19 || 0%{?rhel} >= 7
